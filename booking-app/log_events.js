...
const provider = new Web3.providers.WebsocketProvider("https://ropsten.infura.io/ws/v3/dfa42e01249b4a15b477718fc7aff9cb")
const web3 = new Web3(provider);

const contract_json = fs.readFileSync('/Users/massil/Code/Ethereum/booking-system/build/contracts/TimeTable.json');
...
// contract_instance.methods.getOwners().call().then(array => array.forEach(name => console.log(web3.utils.hexToUtf8(name))));
// contract_instance.once("newRoomBooked", {}, function(error, event) {
// 	console.log(event);
// });
...
const partition1 = '0x5265736572766564000000000000000000000000000000000000000000000000';
